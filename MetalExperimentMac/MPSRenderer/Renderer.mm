...
- (void)mtkView:(nonnull MTKView *)view drawableSizeWillChange:(CGSize)size
{
    ...
    // renderTargetDescriptor.storageMode = MTLStorageModePrivate; failed halfway
    // renderTargetDescriptor.storageMode = MTLStorageModeShared; validate encounter error
#elif TARGET_OS_IPHONE || TARGET_OS_IOS || TARGET_OS_SIMULATOR
    renderTargetDescriptor.storageMode = MTLStorageModeMemoryless;
    // renderTargetDescriptor.storageMode = MTLStorageModePrivate;
